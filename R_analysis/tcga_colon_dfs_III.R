...
# analysis on tcga_coad patients, only consider stage ii and iii patients, clinical information is using Dr.kang's table
...
{
  pstage<-p_data$`Neoplasm Disease Stage American Joint Committee on Cancer Code`[nn]
  if (substr(pstage,7,8)=='II' || substr(pstage,7,9)=='III')
  {
