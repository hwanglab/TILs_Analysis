...
if tcga_coad==true
    ...
    thrWhite=240;
elseif tcga_blca==true
    wsi_path='../../../data/tcga_blca_slide/blca_wsi/';
    ind=1;
    tileSize=round([448,448]./8);
    thrWhite=210;
else
...
addpath(genpath('E:\Hongming\projects\tcga-bladder-mutationburden\tcga_tmb_prediction\utility_funcs\'));
...
for im=ind:numel(imgs)
    ...
    %2) tiling
    bwTissue=rgb2gray(RGB)<thrWhite;
